...
import com.a1tt.notebook.customView.animation.type.*;
import com.a1tt.notebook.customView.draw.controller.DrawController;
import com.a1tt.notebook.customView.draw.data.Indicator;
import com.a1tt.notebook.customView.draw.data.Orientation;
import com.a1tt.notebook.customView.draw.data.PositionSavedState;
import com.a1tt.notebook.customView.draw.data.RtlMode;
import com.a1tt.notebook.customView.utils.CoordinatesUtils;
import com.a1tt.notebook.customView.utils.DensityUtils;
import com.a1tt.notebook.customView.utils.IdUtils;
...
public class PageIndicatorView extends View implements ViewPager.OnPageChangeListener, IndicatorManager.Listener, ViewPager.OnAdapterChangeListener, View.OnTouchListener {
    ...
    private TextView mPrevText, mNextText;
    ...
    protected void onAttachedToWindow() {
        ...
        mPrevButton = ((ViewGroup) getParent()).findViewById(R.id.prev_button);
        mPrevText = ((ViewGroup) getParent()).findViewById(R.id.prev_text);
        mNextText = ((ViewGroup) getParent()).findViewById(R.id.next_text);
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        if (position == 0) {
            mPrevText.setVisibility(INVISIBLE);
            mPrevButton.setVisibility(INVISIBLE);
        } else {
            mPrevText.setVisibility(VISIBLE);
            mPrevButton.setVisibility(VISIBLE);
        }
        if (position == viewPager.getAdapter().getCount() - 1 ) {
            mNextText.setText("start");
        } else {
